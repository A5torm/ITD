            ...
            case AIState.Spinning:
                {
                    ...
                    if (Projectile.owner == Main.myPlayer)
                    {
                        ...
                        {
                            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, shootDirection * 10, (int)Projectile.ai[2], Projectile.damage / 2, Projectile.knockBack, Projectile.owner);
            ...
            case AIState.LaunchingForward:
                {
                    ...
                    if (Projectile.owner == Main.myPlayer)
                    {
                        ...
                        {
                            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Vector2.UnitX.RotatedBy(Projectile.rotation) * 10, (int)Projectile.ai[2], Projectile.damage / 2, Projectile.knockBack, Projectile.owner);
