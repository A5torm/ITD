...
public class BleedbreakerSwing : ModProjectile
{
    ...
    public override void ModifyHitNPC(NPC target, ref NPC.HitModifiers modifiers)
    {
        ...
        {
            case 2:
                modifiers.FinalDamage.Flat = Projectile.damage * (swingCharge / 60);
                break;
            case 3:
                modifiers.FinalDamage.Flat = Projectile.damage * (swingCharge / 120);
                break;
        }
    }
    ...
    ModContent.ProjectileType<BleedbreakerKnockbackBomb>(), Projectile.damage * (1 + swingCharge / 120), 0f, -1, target.whoAmI, Projectile.spriteDirection);
